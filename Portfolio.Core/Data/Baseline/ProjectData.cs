...
namespace Portfolio.Core.Data.Baseline
{
    public static class ProjectData
    {
        ...
        public static readonly Project AutonomousStockAnalysisTool = new Project
        {
            ...
            Description = "A private tool for performing technical analyses on entire stock indexes. The analysis is based on a value investment strategy and is run each weekday from Dennis private server.",
            Category = ProjectCategory.FreeTime,
